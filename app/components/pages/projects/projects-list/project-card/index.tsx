...
export const ProjectCard = ({ project }: ProjectCardProps) => {
  ...
  return (
    <div className="rounded-lg h-[436px] flex flex-col bg-zinc-800 overflow-hidden group transition-all border-2 border-zinc-800 hover:border-amber-500 opacity-70 hover:opacity-100 text-xs">
